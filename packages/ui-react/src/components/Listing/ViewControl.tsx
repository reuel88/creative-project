...
import { faBinoculars, faGripVertical, faList, faMapLocationDot } from "@fortawesome/free-solid-svg-icons";
...
const ViewControl = () => {
    ...
    const inspectButtonClasses = classNames(
        styles['view-control__button'],
        {
    ...
    return <div className={styles['view-control']}>
        <span className={styles['view-control__label']}>{t("View")}:</span>
        <button className={listButtonClasses}
        ...
        <button className={gridButtonClasses}
        ...
        <button className={mapButtonClasses}
        ...
        <button className={inspectButtonClasses}
