...
const InputPasswordWrapper:FC<IInputProps> = ({value: defaultValue, onChange, ...rest }) => {
    ...
    return <div className="p-4"><InputPassword value={value} onChange={handleChange} {...rest}/></div>
}
