...
const InputPasswordWithRequirementsWrapper: FC<IInputProps> = ({value: defaultValue, onChange, ...rest}) => {
    ...
    return <div className="p-4"><InputPasswordWithRequirements value={value} onChange={handleChange} {...rest} /></div>
}
